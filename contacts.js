 ...
 * pages.contacts
 * 
 * handles actions in contact list page
 */
...
(function (global) {
    ...
    contacts_page.viewContact = function() {
        ...
        viewer.find('span#view-profimg').text(contact.profimg);
        viewer.find('span#view-fname').text(contact.fname);
    ...
    contacts_page.createContactListItem = function(contact) {
        ...
        a.attr('href', '#');
        a.text(contact.fname+" "+contact.lname);
